...
@Component
@ServerEndpoint(value="/ws/{arg}",host = "0.0.0.0",port = "80")
public class MyNetSocket
{
	@BeforeHandshake
	public void handshake(Session session, HttpHeaders headers, @RequestParam
			String req, @RequestParam
